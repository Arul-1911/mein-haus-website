import LoginForm from "@/components/professional/auth/LoginForm";
    ...
    <main>
      <section className="grid md:grid-cols-2 h-screen">
        ...
        <div className="bg-(--primary-light) h-full">
          <div className="mx-auto max-w-2xl flex flex-col items-center py-3 h-full w-full justify-center gap-1 md:gap-2">
            ...
            <div className="my-2">
              <h1 className="font-primary text-primary px-1 my-1 font-bold text-xl text-center md:text-2xl">
            ...
            <div className="mt-2 relative group h-[25dvh] w-[35dvh] md:w-[70%] md:h-[50%]">
              <Image
                ...
                // width={450}
                fill
                src="/professional/auth/login.png"
