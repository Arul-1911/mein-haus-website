...
import AddAdditionalWork from "@/components/customer/ongoing-work/add-additional-work";
import AdditionalWorks from "@/components/customer/ongoing-work/additional-works";
...
async function OngoingServiceDetailsPage({ params }) {
  const { serviceid } = await params;
  const data = ongoingWorkServiceData.find(
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 font-medium gap-10 items-center w-full">
                    ...
                    {data?.services > 0 && (
                      <div className="">
                        ...
                        <p className="ml-3 bg-[#FD760D1F] text-[#FD760D] px-2 py-1 w-fit rounded-2xl">
                          {data?.status}
                        </p>
                      </div>
                    )}
          ...
          <div className="col-span-12 lg:col-span-4">
            ...
            <div className="mt-6 bg-[#1E9BD01F] flex justify-between items-center p-4 rounded-2xl">
              ...
              <div className="relative h-15 w-15">
                <Image
                  src="/customer/root/ongoing-work/notes-img.png"
                  alt="Notes image"
                  fill
...
export default OngoingServiceDetailsPage;
